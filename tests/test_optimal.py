...
class TestAddToOptimal(unittest.TestCase):
    ...
    def test_basic_optimal(self):
        ...
        self.assertEqual(self.optimal["RB"][0].points, 12)
        ...
        self.assertIn(10, [x.points for x in self.optimal["RB"]])
        ...
        self.assertIn(10, [x.points for x in self.optimal["RB"]])
        self.assertEqual(len(self.optimal["RB"]), self.settings["RB"])
        self.assertIn(8, [x.points for x in self.optimal[self.flex]])
        ...
        self.assertEqual(len(self.optimal["RB"]), self.settings["RB"])
        self.assertIn(10, [x.points for x in self.optimal[self.flex]])
        self.assertEqual(len(self.optimal[self.flex]), self.settings[self.flex])
